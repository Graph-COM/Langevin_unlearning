    ...
    def train(self):
        if self.args.search_burnin:
            if self.args.dataset == 'MNIST':
                # list for MNIST
                sigma_list = [0.01]
                burn_in_list = [10, 2000, 3000, 5000, 10000]
    ...
    def search_burnin(self, sigma_list, burn_in_list, fig_path = '_search_burnin.pdf'):
        ...
        for sigma in sigma_list:
            ...
            for idx in range(len(burn_in_list)):
                ...
                accuracy, _, new_w_list = self.get_mean_performance(self.X_train, self.y_train, step, sigma, this_w_list, len_list = 100, return_w = True)
